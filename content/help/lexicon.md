...
- Classe **instanciable**: classe dont on peut construire des instances, c'est-à-dire qui n'est donc pas abstraite et qui possède au moins un constructeur public.
- Classe **copiable**: classe qui possède un constructeur de copie (public).
- Classe **déplaçable**: classe qui possède un constructeur de déplacement (public).
